/*
    Somewhat verbose method of generating standard deviation;
    prints a lot of junk
*/
    ...
    void makeManyHERF() {
        ...
        for(int j=0; j<depth; j++) {
            ...
            if(j == 0) {
                ...
                hyperEuclidSetInstance[j].printIOIstat(j);       // new 10/2024
            }
        }
    }
